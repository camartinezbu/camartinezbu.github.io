---
title: 4 paquetes para hacer mapas en R
...
![Mapa de las localidades de Bogotá usando ggplot2](mapa_ggplot.png)
...
![Mapa de las localidades de Bogotá usando tmap](mapa_tmap.png)
...
<div style = "height: 30em; padding: 0; display: flex; justify-content: center;" class = "htmlwidget" >
    <iframe src="./mapa_leaflet_files/mapa_leaflet.html" style = "width: 100%; height:100%;"></iframe>
</div>
